...
export default function HeadlinesSection(): JSX.Element {
    ...
    return (
        <Section className="flex h-38 sm:h-42 md:h-44 overflow-hidden">
            <section className="h-full aspect-square border-r border-border relative shrink-0">
                <div className="rounded-full border border-border h-full w-full p-0.5 sm:p-1 overflow-hidden">
            ...
            <section className="flex-1 min-w-0 flex flex-col justify-end text-light">
                <div className="text-muted text-sm px-5 border-b border-border truncate">
                    I build systems that scale.
                </div>
                <div className="text-3xl px-5 flex items-center justify-start font-semibold gap-x-1 border-b border-border">
