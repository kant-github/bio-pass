...
export default function Home() {
    return (
        <div className="flex h-[200vh] flex-col bg-darkest">
            ...
            <Section className="flex h-38 sm:h-42 md:h-44">
                <section className="h-full aspect-square border-r border-neutral-800/70 relative">
                    <Image
                        height={60}
                        width={60}
                ...
                <section className="flex-1 flex flex-col justify-end text-light">
                    <div className="text-light/20 text-sm px-5 border-b border-neutral-800/70">
                    ...
                    <div className="h-8 flex items-center justify-start">
                        <TextLoopWrapper
                            className="px-5 text-light/70 text-base font-light"
                            slugs={[
